...
public class DeleteriousStopGain {

    public DeleteriousStopGain(){
//        this.countDeleteriousVMapII_byChr();

    }

    public void countDeleteriousVMapII_byChr(String infileS,String type, String addCountFileAddGroupS) {
...
//                }
                ...
                if(type.equals("004_stopGain")){
                    if (!variantType.equals("STOP-GAIN")) continue;
                }
                if (type.equals("005_stopLoss")){
                    if (!variantType.equals("STOP-LOSS")) continue;
                }
                if (type.equals("006_startLost")){
                    if (!variantType.equals("START-LOST")) continue;
                }
